...
static struct cardSetData {
    ...
    {  1, "use_coreset", "core", "Core Set", NRCycleCoreDeluxe },
    {  8, "use_creation_and_control", "cac", "Creation and Control", NRCycleCoreDeluxe },
    { 15, "use_honor_and_profit", "hap", "Honor and Profit", NRCycleCoreDeluxe },
    
    // genesis
    { 2, "use_what_lies_ahead", "wla", "What Lies Ahead", NRCycleGenesis },
    { 3, "use_trace_amount", "ta", "Trace Amount", NRCycleGenesis },
    { 4, "use_cyber_exodus", "ce", "Cyber Exodus", NRCycleGenesis },
    { 5, "use_study_in_static", "asis", "A Study in Static", NRCycleGenesis },
    { 6, "use_humanitys_shadow", "hs", "Humanity's Shadow", NRCycleGenesis },
    { 7, "use_future_proof", "fp", "Future Proof", NRCycleGenesis },
    
    // spin
    {  9, "use_opening_moves", "om", "Opening Moves", NRCycleSpin },
    { 10, "use_second_thoughts", "st", "Second Thoughts", NRCycleSpin },
    { 11, "use_mala_tempora", "mt", "Mala Tempora", NRCycleSpin },
    { 12, "use_true_colors", "tc", "True Colors", NRCycleSpin },
    { 13, "use_fear_and_loathing", "fal", "Fear and Loathing", NRCycleSpin },
    { 14, "use_double_time", "dt", "Double Time", NRCycleSpin },
    
    // lunar
    { 16, "use_upstalk", "up", "Upstalk", NRCycleLunar },
    { 0 }
};
